...
handle(1201, #m_1201_tos{start = Start, type = Type, num = Num, up_or_down = UpDown, date = Date}, Role = #role{item = Item, great_match = Great}) ->
    {List, N, Value} = 
        ...
        0 ->
            case Type of
                ...
                ?rank_kill_week ->
                    Role#role.week_kill;
                ?rank_great_match ->
                    Great#great_match.daily_score;
                ?rank_week_great_match ->
                    Great#great_match.week_score
            end;
        _ ->
            Value
    end,
