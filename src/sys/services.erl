...
%% 游戏区
cfg(local) ->
    {ok, [role_charge_exchange_account, friend_mgr, functions_mgr, great_account_mgr, great_match_mgr, role_charge_mgr, role_black, role_account_mgr, area_account_mgr, task_mgr, setting_mgr, account_mgr, animal_account_mgr, weixin_mgr, shop_redbag, shop, area_mgr, mail_mgr, boradcast_mgr, animal_mgr, log_mgr, rank_mgr, role_data,  auto_increment, web_mgr, sup_acceptor, sys_listener]};
