...
-ifndef(M_1153_TOS_PB_H).
-define(M_1153_TOS_PB_H, true).
-record(m_1153_tos, {
    type = erlang:error({required, type}),
    num = erlang:error({required, num})
}).
...
-ifndef(M_1501_TOS_PB_H).
-define(M_1501_TOS_PB_H, true).
-record(m_1501_tos, {
    
}).
-endif.

-ifndef(M_1501_TOC_PB_H).
-define(M_1501_TOC_PB_H, true).
-record(m_1501_toc, {
    
}).
-endif.

-ifndef(P_AREA_ROLE_PB_H).
-define(P_AREA_ROLE_PB_H, true).
-record(p_area_role, {
    role_id = erlang:error({required, role_id}),
    name = erlang:error({required, name}),
    skill_list = [],
...
-ifndef(M_1502_TOS_PB_H).
-define(M_1502_TOS_PB_H, true).
-record(m_1502_tos, {
    
}).
-endif.

-ifndef(M_1502_TOC_PB_H).
-define(M_1502_TOC_PB_H, true).
-record(m_1502_toc, {
    
}).
-endif.

-ifndef(M_1503_TOS_PB_H).
-define(M_1503_TOS_PB_H, true).
-record(m_1503_tos, {
    id = erlang:error({required, id})
}).
-endif.

-ifndef(M_1503_TOC_PB_H).
-define(M_1503_TOC_PB_H, true).
-record(m_1503_toc, {
    
}).
-endif.

-ifndef(M_1504_TOS_PB_H).
-define(M_1504_TOS_PB_H, true).
-record(m_1504_tos, {
    type = erlang:error({required, type})
}).
-endif.

-ifndef(M_1504_TOC_PB_H).
-define(M_1504_TOC_PB_H, true).
-record(m_1504_toc, {
    
}).
-endif.

-ifndef(M_1505_TOC_PB_H).
-define(M_1505_TOC_PB_H, true).
-record(m_1505_toc, {
    role_id = erlang:error({required, role_id}),
    id = erlang:error({required, id})
}).
...
-ifndef(M_1506_TOC_PB_H).
-define(M_1506_TOC_PB_H, true).
-record(m_1506_toc, {
    animals = []
}).
-endif.

-ifndef(M_1507_TOC_PB_H).
-define(M_1507_TOC_PB_H, true).
-record(m_1507_toc, {
    role_list = []
}).
-endif.

-ifndef(M_1508_TOC_PB_H).
-define(M_1508_TOC_PB_H, true).
-record(m_1508_toc, {
    role_id = erlang:error({required, role_id})
}).
-endif.

-ifndef(M_1509_TOC_PB_H).
-define(M_1509_TOC_PB_H, true).
-record(m_1509_toc, {
    role_id = erlang:error({required, role_id}),
    type = erlang:error({required, type}),
    ids = []
...
-ifndef(M_1510_TOC_PB_H).
-define(M_1510_TOC_PB_H, true).
-record(m_1510_toc, {
    base_id = erlang:error({required, base_id})
}).
-endif.

-ifndef(M_1511_TOC_PB_H).
-define(M_1511_TOC_PB_H, true).
-record(m_1511_toc, {
    id = []
}).
-endif.

-ifndef(M_1512_TOC_PB_H).
-define(M_1512_TOC_PB_H, true).
-record(m_1512_toc, {
    role_id = erlang:error({required, role_id}),
    type = erlang:error({required, type}),
    icon = erlang:error({required, icon}),
...
-ifndef(M_1513_TOC_PB_H).
-define(M_1513_TOC_PB_H, true).
-record(m_1513_toc, {
    animal_list = [],
    time = erlang:error({required, time})
}).
...
-ifndef(M_1514_TOC_PB_H).
-define(M_1514_TOC_PB_H, true).
-record(m_1514_toc, {
    id = erlang:error({required, id}),
    type = erlang:error({required, type})
}).
...
-ifndef(M_1515_TOS_PB_H).
-define(M_1515_TOS_PB_H, true).
-record(m_1515_tos, {
    
}).
-endif.

-ifndef(M_1515_TOC_PB_H).
-define(M_1515_TOC_PB_H, true).
-record(m_1515_toc, {
    num = erlang:error({required, num})
}).
-endif.

-ifndef(M_1516_TOC_PB_H).
-define(M_1516_TOC_PB_H, true).
-record(m_1516_toc, {
    list = []
}).
-endif.

-ifndef(M_1518_TOS_PB_H).
-define(M_1518_TOS_PB_H, true).
-record(m_1518_tos, {
    
}).
-endif.

-ifndef(M_1518_TOC_PB_H).
-define(M_1518_TOC_PB_H, true).
-record(m_1518_toc, {
    animals = [],
    role_list = [],
    time = erlang:error({required, time})
...
-ifndef(M_1606_TOS_PB_H).
-define(M_1606_TOS_PB_H, true).
-record(m_1606_tos, {
    
}).
-endif.

-ifndef(M_1606_TOC_PB_H).
-define(M_1606_TOC_PB_H, true).
-record(m_1606_toc, {
    start_time = erlang:error({required, start_time}),
    end_time = erlang:error({required, end_time}),
    status = erlang:error({required, status}),
...
-ifndef(M_1607_TOS_PB_H).
-define(M_1607_TOS_PB_H, true).
-record(m_1607_tos, {
    
}).
-endif.

-ifndef(M_1607_TOC_PB_H).
-define(M_1607_TOC_PB_H, true).
-record(m_1607_toc, {
    list = []
}).
-endif.

-ifndef(M_1608_TOS_PB_H).
-define(M_1608_TOS_PB_H, true).
-record(m_1608_tos, {
    id = erlang:error({required, id}),
    phone
}).
...
-ifndef(M_1608_TOC_PB_H).
-define(M_1608_TOC_PB_H, true).
-record(m_1608_toc, {
    
}).
-endif.

-ifndef(M_1609_TOS_PB_H).
-define(M_1609_TOS_PB_H, true).
-record(m_1609_tos, {
    
}).
-endif.

-ifndef(M_1609_TOC_PB_H).
-define(M_1609_TOC_PB_H, true).
-record(m_1609_toc, {
    type = erlang:error({required, type})
}).
-endif.
...
-ifndef(M_1906_TOS_PB_H).
-define(M_1906_TOS_PB_H, true).
-record(m_1906_tos, {
    
}).
-endif.

-ifndef(M_1906_TOC_PB_H).
-define(M_1906_TOC_PB_H, true).
-record(m_1906_toc, {
    type = erlang:error({required, type}),
    list = []
}).
...
-ifndef(P_DAILY_GIFT_PB_H).
-define(P_DAILY_GIFT_PB_H, true).
-record(p_daily_gift, {
    id = erlang:error({required, id}),
    type = erlang:error({required, type}),
    price = erlang:error({required, price}),
...
-ifndef(M_1907_TOC_PB_H).
-define(M_1907_TOC_PB_H, true).
-record(m_1907_toc, {
    type = erlang:error({required, type}),
    list = []
}).
...
-ifndef(M_2002_TOS_PB_H).
-define(M_2002_TOS_PB_H, true).
-record(m_2002_tos, {
    
}).
-endif.

-ifndef(M_2002_TOC_PB_H).
-define(M_2002_TOC_PB_H, true).
-record(m_2002_toc, {
    
}).
-endif.

-ifndef(M_2003_TOS_PB_H).
-define(M_2003_TOS_PB_H, true).
-record(m_2003_tos, {
    id = erlang:error({required, id}),
    coin = erlang:error({required, coin})
}).
...
-ifndef(M_2003_TOC_PB_H).
-define(M_2003_TOC_PB_H, true).
-record(m_2003_toc, {
    num = erlang:error({required, num}),
    score = erlang:error({required, score})
}).
...
-ifndef(M_2004_TOS_PB_H).
-define(M_2004_TOS_PB_H, true).
-record(m_2004_tos, {
    type = erlang:error({required, type})
}).
-endif.

-ifndef(M_2004_TOC_PB_H).
-define(M_2004_TOC_PB_H, true).
-record(m_2004_toc, {
    
}).
-endif.

-ifndef(M_2005_TOC_PB_H).
-define(M_2005_TOC_PB_H, true).
-record(m_2005_toc, {
    role_id = erlang:error({required, role_id}),
    id = erlang:error({required, id})
}).
...
-ifndef(M_2006_TOC_PB_H).
-define(M_2006_TOC_PB_H, true).
-record(m_2006_toc, {
    animals = []
}).
-endif.

-ifndef(M_2007_TOC_PB_H).
-define(M_2007_TOC_PB_H, true).
-record(m_2007_toc, {
    role = erlang:error({required, role})
}).
-endif.

-ifndef(M_2008_TOC_PB_H).
-define(M_2008_TOC_PB_H, true).
-record(m_2008_toc, {
    role_id = erlang:error({required, role_id})
}).
-endif.

-ifndef(M_2009_TOC_PB_H).
-define(M_2009_TOC_PB_H, true).
-record(m_2009_toc, {
    role_id = erlang:error({required, role_id}),
    type = erlang:error({required, type}),
    ids = []
...
-ifndef(M_2010_TOC_PB_H).
-define(M_2010_TOC_PB_H, true).
-record(m_2010_toc, {
    base_id = erlang:error({required, base_id})
}).
-endif.

-ifndef(M_2011_TOC_PB_H).
-define(M_2011_TOC_PB_H, true).
-record(m_2011_toc, {
    id = []
}).
-endif.

-ifndef(M_2012_TOC_PB_H).
-define(M_2012_TOC_PB_H, true).
-record(m_2012_toc, {
    role_id = erlang:error({required, role_id}),
    type = erlang:error({required, type}),
    icon = erlang:error({required, icon}),
...
-ifndef(M_2013_TOC_PB_H).
-define(M_2013_TOC_PB_H, true).
-record(m_2013_toc, {
    list = []
}).
-endif.

-ifndef(M_2014_TOC_PB_H).
-define(M_2014_TOC_PB_H, true).
-record(m_2014_toc, {
    id = erlang:error({required, id}),
    type = erlang:error({required, type})
}).
...
-ifndef(M_2015_TOS_PB_H).
-define(M_2015_TOS_PB_H, true).
-record(m_2015_tos, {
    
}).
-endif.

-ifndef(M_2015_TOC_PB_H).
-define(M_2015_TOC_PB_H, true).
-record(m_2015_toc, {
    week_score = erlang:error({required, week_score}),
    daily_score = erlang:error({required, daily_score}),
...
-ifndef(M_2016_TOS_PB_H).
-define(M_2016_TOS_PB_H, true).
-record(m_2016_tos, {
    
}).
-endif.

-ifndef(M_2016_TOC_PB_H).
-define(M_2016_TOC_PB_H, true).
-record(m_2016_toc, {
    
}).
-endif.

-ifndef(M_2017_TOS_PB_H).
-define(M_2017_TOS_PB_H, true).
-record(m_2017_tos, {
    
}).
-endif.

-ifndef(M_2017_TOC_PB_H).
-define(M_2017_TOC_PB_H, true).
-record(m_2017_toc, {
    base = erlang:error({required, base}),
    high = erlang:error({required, high}),
    vip = erlang:error({required, vip}),
    repeat = erlang:error({required, repeat}),
    task = erlang:error({required, task}),
    once = erlang:error({required, once}),
    score = erlang:error({required, score}),
    status = erlang:error({required, status})
}).
-endif.

-ifndef(M_2018_TOS_PB_H).
-define(M_2018_TOS_PB_H, true).
-record(m_2018_tos, {
    
}).
-endif.

-ifndef(M_2018_TOC_PB_H).
-define(M_2018_TOC_PB_H, true).
-record(m_2018_toc, {
    animals = [],
    role_list = [],
    time = erlang:error({required, time}),
...
-ifndef(M_2019_TOC_PB_H).
-define(M_2019_TOC_PB_H, true).
-record(m_2019_toc, {
    
}).
-endif.

-ifndef(M_2021_TOS_PB_H).
-define(M_2021_TOS_PB_H, true).
-record(m_2021_tos, {
    type = erlang:error({required, type}),
    to_id = erlang:error({required, to_id})
}).
...
-ifndef(M_2021_TOC_PB_H).
-define(M_2021_TOC_PB_H, true).
-record(m_2021_toc, {
    role_id = erlang:error({required, role_id}),
    type = erlang:error({required, type}),
    to_id = erlang:error({required, to_id})
