...
-define(charge_daily_gift1, 101).  %% 每日礼包1
-define(charge_daily_gift2, 102).  %% 每日礼包2
-define(charge_daily_gift3, 103).  %% 每日礼包3
-define(charge_daily_gift4, 104).  %% 每日礼包4
-define(charge_daily_gift5, 105).  %% 每日礼包5
-define(charge_daily_gift6, 106).  %% 每日礼包6
-define(charge_daily_gift7, 107).  %% 每日礼包7
-define(charge_daily_gift8, 108).  %% 每日礼包8
-define(charge_daily_gift9, 109).  %% 每日礼包9
-define(charge_daily_gift10, 110).  %% 每日礼包10
-define(charge_daily_gift11, 111).  %% 每日礼包11
-define(charge_daily_gift12, 112).  %% 每日礼包12
-define(charge_daily_gift13, 113).  %% 每日礼包13
-define(charge_daily_gift14, 114).  %% 每日礼包14
-define(charge_daily_gift15, 115).  %% 每日礼包15
-define(charge_daily_gift16, 116).  %% 每日礼包16
-define(charge_daily_gift17, 117).  %% 每日礼包17
-define(charge_daily_gift18, 118).  %% 每日礼包18
...
-define(setting_shop_redbag, 17).  %% 设置福袋商店
-define(setting_redbag_exchange, 18).  %% 设置是否开启福袋商店
-define(setting_redbag_exchange_num, 19).  %% 设置是福袋商店红包兑换的最大额度（每周）
