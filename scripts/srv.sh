...
fun_ssh() {
        cd $ROOT/..
        scp -r ebin root@120.78.222.244:/mnt/guess_new/
        echo 上传成功
}
...
fun_sync_proto() {
    cd $ROOT/..
    cp include/error_msg.hrl ../../program/guess_new/main/error_msg/
    cp protobuffs/proto/*.proto ../../program/guess_new/main/proto/
    cd ../../program/guess_new/main && svn up && svn ci -m ""
}
fun_data() {
    cd $ROOT/..
